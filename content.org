...
**** Kaigi on Rails 2021タイムテーブル完全解説
     [[https://kaigionrails.org/2021/timetable/#day1][Kaigi on Rails 2021]] の各発表のタイムテーブル、
...
**** スポンサーセッション: リンクアンドモチベーション様
     ...
     気になる方はお早めに。
**** スポンサーセッション: DeNA 様
     [[https://desc-hc.co.jp/service/health_insurance_association][kencom]] というサービスのご紹介と
